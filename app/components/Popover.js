 ...
 * 气泡弹窗
 * @author chengkai
 * clone from https://github.com/jeanregisser/react-native-popover 修改语法为ES6
 *
 *
     example:

     showPopover = () => {
            this.popoverBtn.measure((ox, oy, width, height, px, py) => {
     ...
     renderTitleClickView() {
            return (
                <View style={{width: px(300), height: px(220), justifyContent: 'space-around', alignItems: 'center', backgroundColor: '#49494B'}}>
                    <TouchableOpacity
                        style={{flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}
                        onPress={() => {showToast('a')}}>
                        <Image style={{width: px(37), height: px(37)}}
                               source={require('../../../assets/images/home/home_install_machine.png')}
                        />
                        <Text style={{fontSize: px(28), color: theme.COLOR_WHITE, marginLeft: px(8)}}>添加我的信用卡</Text>
                    </TouchableOpacity>
                    <View style={{width: px(250), height: px(3), marginLeft: px(15), backgroundColor: '#1F1F1F'}}/>
                    <TouchableOpacity
                        style={{flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}
                        onPress={() => {showToast('b')}}>
                        <Image style={{width: px(37), height: px(37)}}
                               source={require('../../../assets/images/home/home_install_machine.png')}
                        />
                        <Text style={{fontSize: px(28), color: theme.COLOR_WHITE, marginLeft: px(8)}}>添加常用信用卡</Text>
                    </TouchableOpacity>
                </View>
            );
        }
     ...
     render () {
        return (
            <View>
                <TouchableOpacity
                        ref={ref => this.popoverBtn = ref}
                        onPress={this.showPopover}
                    >
                        <Image
                            style={styles.headportraitStyle}
                            source={require('../../../assets/images/auth/register/headportrait.png')}
                        />
                    </TouchableOpacity>
            </View>
                 <Popover
                     ...
                     contentStyle={{backgroundColor:'#49494B', opacity:1}}
                     placement="bottom">
...
class Popover extends Component{
    static propTypes = {
        ...
        repairValStyle: PropTypes.object, // 样式修复值
    }
    ...
    render() {
        ...
        // style 修复值
        let {repairValStyle = {}} = this.props;

        return (
            <TouchableWithoutFeedback onPress={this.props.onClose}>
                <View style={[styles.container, contentSizeAvailable && styles.containerVisible, repairValStyle]}>
